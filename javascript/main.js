...
var productInfo = document.getElementById("card-container");
...
for (var i = 0; i < 3; i++) {
	...
	productInfo.innerHTML += "<div class='productContainer'>" + "<div class='dogpic'>" + pURL +"</div>" + "<div class='dogname'>" + pName +"</div>" + "<div class='dogdesc'>" + pDesc +"</div>" +"<div class='dogprice'>" + pPrice +"</div>" +"<div class='dogsize'>" + pSize +"</div>" + "<button class='buy'>" + "SOLD OUT" + "</button>" + "</div>"
};